...
from models.pretrain_keys_pair import pairs_keys
...
class Encoder_Decoder(nn.Module):
    ...
    def forward(self, x):
        ...
        return raw_alpha
        # else:
        #     raw_alpha_in = (raw_alpha - 0.5) / 0.5
        #     refine_in = torch.cat((x[:, :3, :, :], raw_alpha_in), 1)
        #     refine_alpha = self.refine_head(refine_in)
        #     refine_alpha = refine_alpha + raw_alpha
